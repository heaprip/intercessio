...
| Счёт внутри правил вывода | за счётом придёт агрегация и собственный порядок вычисления; считает линтер | [[docs/design/deduction\|deduction]] |
...
| Запрет переворота нормой в движке | римская конституция такой нормы не имела; защита была структурной, а вшитый запрет делает провал недостижимым | [[docs/design/casus-decemvirate\|casus-decemvirate]] |
