...
истинным, ложным и **неопределённым**. Неопределённость возникает там, где
нормы ссылаются друг на друга через отрицание по кругу либо где условие ни
подтверждается, ни опровергается имеющимися фактами.
