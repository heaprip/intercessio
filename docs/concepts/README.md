...
| [[docs/concepts/cases#Последствие нарушения\|Последствие нарушения]] (`Reparation`) | Вторичная обязанность, возникающая из нарушения |
...
| [[docs/concepts/derivation#Non liquet\|Non liquet]] (`NonLiquet`) | Исход «не ясно»: корпус не даёт по делу определённого ответа |
