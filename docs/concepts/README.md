...
| [[docs/concepts/game#Стопка\|Стопка]] (`Stack`) | Карточки, которые auctor разбирает между периодами |
| [[docs/concepts/game#Карточка\|Карточка]] (`Card`) | Одна причина изменить закон и предложение правки к ней |
...
| [[docs/concepts/cases#Акт должности\|Акт должности]] (`Act`) | Решение без дела в пределах компетенции должности |
