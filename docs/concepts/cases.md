...
[[docs/concepts/cases#Решение|Решение]] без [[docs/concepts/cases#Дело|дела]]: должность
прямо меняет статус, обязанность или занятие должности в пределах своей
[[docs/concepts/institutions#Компетенция|компетенции]]. У акта есть должность,
провенанс, период и [[docs/concepts/cases#Вступление в силу|вступление в силу]], но нет
прошения и установления факта. Коллегиальной должности для акта нужно согласие
держателей.

Усыновление, цензорская нота, освобождение от повинности, назначение — акты, а не дела.

**Не путать с** решением по делу: у решения есть спор и стороны, у акта — только
должность и её компетенция.
