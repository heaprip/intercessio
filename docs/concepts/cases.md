...
Утверждение становится установленным фактом только процедурой, и факт несёт провенанс. Дело открывается прошением или выведенным нарушением и кончается решением, которое проходит intercessio, пересмотр, вступление в силу и исполнение — и само становится фактом. Нарушение влечёт последствие, а проступком становится только решением.
...
Нарушение может повлечь [[docs/concepts/cases#Последствие нарушения|вторичную обязанность]].
